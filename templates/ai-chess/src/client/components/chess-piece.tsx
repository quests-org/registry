...
// Chess piece SVG components using Wikimedia Commons standard pieces
// Reference: https://commons.wikimedia.org/wiki/Category:SVG_chess_pieces
const ChessPieceIcon: React.FC<{
  piece: string;
  color: string;
  size: number;
}> = ({ piece, color, size }) => {
  ...
  const strokeColor = "#000000"; // Black border for visibility
      ...
      return (
        <svg {...commonProps}>
          ...
          >
            ...
            />
            <path d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 11.5,37 z " />
    ...
    case "q": // Queen
      return (
        <svg {...commonProps}>
          ...
          >
            <path
              d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38,14 L 31,25 L 31,11 L 25.5,24.5 L 22.5,9.5 L 19.5,24.5 L 14,11 L 14,25 L 7,14 L 9,26 z"
              strokeLinejoin="miter"
            />
            <path
...
export const ChessPiece: React.FC<ChessPieceProps> = ({
  ...
  return (
    <div className={cn("flex items-center justify-center", className)}>
      <ChessPieceIcon piece={pieceType} color={color} size={size} />
    </div>
  );
};
